...
How the selfie page uses them (`src/components/liveness-html.ts`) follows the project's own `test.py`: the face box is
...
only the straight-ahead frames are scored.
