// Generated from the IANA time zone database (zone.tab plus backward links). Public domain.
// A phone's time zone is a city, e.g. "Africa/Johannesburg", so it gives an instant, offline, permission-free
// idea of roughly where the user is: [latitude, longitude].
export const TIMEZONE_CITIES: Record<string, readonly [number, number]> = {
